...
<h2> What I Do: </h2>
⚡ ⚡ Experienced in end-to-end data engineering on AWS and Azure, leveraging Databricks, PySpark, Delta Lake, and ADF to build robust pipelines

⚡ ⚡ Skilled at workflow orchestration and automation using Airflow, Azure DevOps, GitHub, and Docker for reliable, reproducible processes

⚡ ⚡ Transforming raw data into business intelligence with Power BI, Tableau, and Excel dashboards
